...
/**
 * External Content plugin: callback script
 *
...
require_once "./Customizing/global/plugins/Services/Repository/RepositoryObject/ExternalContent/classes/class.ilObjExternalContentGUI.php";

//$track_obj = new ilObjExternalContent();
